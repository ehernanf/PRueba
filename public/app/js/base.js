...
function limpiar(){
  ...
  $(document).ready(function(){
    ...
    if (confirm('ATENCI\u00d3N. Esta seguro que quiere realizar esta operaci\u00f3n?')) {
         ...
         var oOptions = {
                type: 'GET',
                url: CI.base_url + 'paquete/resetBD/' ,
                dataType: 'json'
            };
...
$('#rpt1').on("click", function(){
    $("li[id^='menu']").removeClass('mm-selected'); 
     $("#rpt2").removeClass('mm-selected');
      $("#limpiarbd").removeClass('mm-selected');      
    $("#rpt1").addClass('mm-selected');
});

$('#rpt2').click(function () {
    $("li[id^='menu']").removeClass('mm-selected');
     $("#rpt1").removeClass('mm-selected');
      $("#limpiarbd").removeClass('mm-selected');      
    $("#rpt2").addClass('mm-selected');
});

$('#limpiarbd').click(function () {
    $("li[id^='menu']").removeClass('mm-selected');
     $("#rpt1").removeClass('mm-selected');
    $("#rpt2").removeClass('mm-selected');
   
    $("#limpiarbd").addClass('mm-selected');
});